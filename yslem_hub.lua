...
-- GUI BUILDER
-- ===================================================================
for _,name in pairs({"JispiHubGUI","KINGzHubGUI","YslemHubGUI","YslemMobile"}) do
...
gui.Name = "YslemHubGUI"; gui.ResetOnSpawn = false; gui.DisplayOrder = 10
gui.IgnoreGuiInset = true; gui.Parent = LP:WaitForChild("PlayerGui")

-- STEAL BAR (redesign)
local stealProgressBar = Instance.new("Frame", gui)
stealProgressBar.Size = UDim2.new(0,300,0,68)
stealProgressBar.Position = UDim2.new(0.5,-150,1,-86)
stealProgressBar.BackgroundColor3 = C_PANEL
stealProgressBar.BorderSizePixel = 0; stealProgressBar.ZIndex = 100
addCorner(stealProgressBar,14)
addStroke(stealProgressBar, C_YSLEM, 1.5, 0.3)

local sbTitle = Instance.new("TextLabel", stealProgressBar)
sbTitle.Size = UDim2.new(0.5,0,0,14); sbTitle.Position = UDim2.new(0,16,0,8)
sbTitle.BackgroundTransparency = 1; sbTitle.Text = "AUTO STEAL"
sbTitle.TextColor3 = C_YSLEM; sbTitle.Font = Enum.Font.GothamBlack; sbTitle.TextSize = 11
sbTitle.TextXAlignment = Enum.TextXAlignment.Left; sbTitle.ZIndex = 101

local pctLbl = Instance.new("TextLabel", stealProgressBar)
pctLbl.Size = UDim2.new(0,60,0,20); pctLbl.Position = UDim2.new(0,16,0,22)
pctLbl.BackgroundTransparency = 1; pctLbl.Text = "0%"
pctLbl.TextColor3 = C_WHITE; pctLbl.Font = Enum.Font.GothamBlack; pctLbl.TextSize = 22
pctLbl.TextXAlignment = Enum.TextXAlignment.Left; pctLbl.ZIndex = 101

progressRadLbl = Instance.new("TextLabel", stealProgressBar)
progressRadLbl.Size = UDim2.new(0.5,-16,0,28); progressRadLbl.Position = UDim2.new(0.5,0,0,12)
progressRadLbl.BackgroundTransparency = 1; progressRadLbl.Text = "Radius "..AutoSteal.Radius
progressRadLbl.TextColor3 = C_ACCENT2; progressRadLbl.Font = Enum.Font.GothamBold; progressRadLbl.TextSize = 14
progressRadLbl.TextXAlignment = Enum.TextXAlignment.Right; progressRadLbl.ZIndex = 101

local barTrack = Instance.new("Frame", stealProgressBar)
barTrack.Size = UDim2.new(1,-32,0,10); barTrack.Position = UDim2.new(0,16,1,-16)
barTrack.BackgroundColor3 = C_OFF_BG; barTrack.BorderSizePixel = 0; barTrack.ZIndex = 101
addCorner(barTrack,5)

local barFill = Instance.new("Frame", barTrack)
barFill.Size = UDim2.new(0,0,1,0); barFill.BackgroundColor3 = C_YSLEM
barFill.BorderSizePixel = 0; barFill.ZIndex = 102
addCorner(barFill,5)
addGradient(barFill, C_YSLEM, C_PINK, 0)
...
makeDraggable(stealProgressBar)
...
accentBar.Size = UDim2.new(1,0,0,3); accentBar.Position = UDim2.new(0,0,0,60)
accentBar.BackgroundColor3 = C_YSLEM; accentBar.BorderSizePixel = 0; accentBar.ZIndex = 6
addGradient(accentBar, C_YSLEM, C_PINK, 0)

local logoDot = Instance.new("Frame", header)
logoDot.Size = UDim2.new(0,10,0,10); logoDot.Position = UDim2.new(0,16,0.5,-5)
logoDot.BackgroundColor3 = C_YSLEM; logoDot.BorderSizePixel = 0; logoDot.ZIndex = 7
addCorner(logoDot,5)
addGradient(logoDot, C_YSLEM, C_PINK, 45)

local titleLbl = Instance.new("TextLabel", header)
titleLbl.Size = UDim2.new(1,-90,0,20); titleLbl.Position = UDim2.new(0,34,0,12)
titleLbl.BackgroundTransparency = 1; titleLbl.Text = "YSLEM HUB"
titleLbl.TextColor3 = C_WHITE; titleLbl.Font = Enum.Font.GothamBlack; titleLbl.TextSize = 17
titleLbl.TextXAlignment = Enum.TextXAlignment.Left; titleLbl.ZIndex = 7

local subLbl = Instance.new("TextLabel", header)
subLbl.Size = UDim2.new(1,-90,0,14); subLbl.Position = UDim2.new(0,34,0,32)
subLbl.BackgroundTransparency = 1; subLbl.Text = "STEAL • BRAINROT"
subLbl.TextColor3 = C_PINK; subLbl.Font = Enum.Font.GothamBold; subLbl.TextSize = 9
subLbl.TextXAlignment = Enum.TextXAlignment.Left; subLbl.ZIndex = 7

local closeBtn = Instance.new("TextButton", gui)
closeBtn.Size = UDim2.new(0,28,0,28)
closeBtn.BackgroundColor3 = Color3.fromRGB(40,30,55); closeBtn.BorderSizePixel = 0
closeBtn.Text = "✕"; closeBtn.TextColor3 = C_ACCENT2
closeBtn.Font = Enum.Font.GothamBlack; closeBtn.TextSize = 13; closeBtn.ZIndex = 50
addCorner(closeBtn,14); addStroke(closeBtn, C_BORDER2, 1, 0.4)

local miniBtn = Instance.new("TextButton", gui)
miniBtn.Name = "YslemMini"; miniBtn.Size = UDim2.new(0,130,0,34)
miniBtn.Position = UDim2.new(0,8,0,70)
miniBtn.BackgroundColor3 = C_YSLEM; miniBtn.BorderSizePixel = 0
miniBtn.Text = "YSLEM HUB"; miniBtn.TextColor3 = C_WHITE
miniBtn.Font = Enum.Font.GothamBlack; miniBtn.TextSize = 12
miniBtn.Visible = false; miniBtn.ZIndex = 50
addCorner(miniBtn,10); addGradient(miniBtn, C_YSLEM, C_PINK, 25)
...
local function updateCloseBtn()
	if main.Visible then
		...
		closeBtn.Position = UDim2.new(p.X.Scale, p.X.Offset+280-38, p.Y.Scale, p.Y.Offset+16)
	end
end
...
scroll.Size = UDim2.new(1,0,1,-63); scroll.Position = UDim2.new(0,0,0,63)
scroll.BackgroundTransparency = 1; scroll.BorderSizePixel = 0; scroll.ScrollBarThickness = 3
scroll.ScrollBarImageColor3 = C_YSLEM; scroll.AutomaticCanvasSize = Enum.AutomaticSize.Y
...
local function makeSectionLabel(text)
	local row=Instance.new("Frame",scroll); row.Size=UDim2.new(1,0,0,24); row.BackgroundTransparency=1; row.LayoutOrder=LO()
	local bar=Instance.new("Frame",row); bar.Size=UDim2.new(0,3,0,12); bar.Position=UDim2.new(0,0,0.5,-6)
	bar.BackgroundColor3=C_YSLEM; bar.BorderSizePixel=0; addCorner(bar,2)
	local lbl=Instance.new("TextLabel",row); lbl.Size=UDim2.new(1,-10,1,0); lbl.Position=UDim2.new(0,10,0,0); lbl.BackgroundTransparency=1
	lbl.Text=text:upper(); lbl.TextColor3=C_ACCENT2; lbl.Font=Enum.Font.GothamBlack; lbl.TextSize=11; lbl.TextXAlignment=Enum.TextXAlignment.Left
end

local function makeInputRow(label, default, onChange)
	local row = Instance.new("Frame", scroll); row.Size = UDim2.new(1,0,0,38); row.BackgroundColor3 = C_ROW
	row.BorderSizePixel = 0; row.LayoutOrder = LO()
	addCorner(row,10); addStroke(row, C_BORDER, 1, 0.3)
	...
	local box = Instance.new("TextBox", row); box.Size = UDim2.new(0,84,0,28); box.Position = UDim2.new(1,-94,0.5,-14)
	box.BackgroundColor3 = C_BG; box.BorderSizePixel = 0
	box.Text = tostring(default); box.TextColor3 = C_ACCENT2
	box.Font = Enum.Font.GothamBlack; box.TextSize = 15; box.ClearTextOnFocus = false  -- FIX : ne pas vider au clic
	box.TextEditable = true; box.Active = true; box.Selectable = true; box.ZIndex = 8
	addCorner(box,8); addStroke(box, C_BORDER2, 1, 0.2)
	box.FocusLost:Connect(function()
		local num = tonumber(box.Text)
		if num then
			local f = math.clamp(num, 0.05, 9999)
			-- Affichage entier si entier, décimal sinon
...
local function makeStatusRow(label, valTxt)
	local row=Instance.new("Frame",scroll); row.Size=UDim2.new(1,0,0,32); row.BackgroundColor3=C_ROW
	row.BorderSizePixel=0; row.LayoutOrder=LO()
	addCorner(row,10); addStroke(row, C_BORDER, 1, 0.3)
	local lbl=Instance.new("TextLabel",row); lbl.Size=UDim2.new(0.5,0,1,0); lbl.Position=UDim2.new(0,14,0,0)
	...
	local val=Instance.new("TextLabel",row); val.Size=UDim2.new(0.45,-12,1,0); val.Position=UDim2.new(0.52,0,0,0)
	val.BackgroundTransparency=1; val.Text=valTxt; val.TextColor3=C_YSLEM
	val.Font=Enum.Font.GothamBlack; val.TextSize=14; val.TextXAlignment=Enum.TextXAlignment.Right
	return val
end
...
local function makeToggleRow(label, defaultOn, onToggle, keybindStateKey)
	...
	local lbl=Instance.new("TextLabel",row); lbl.Size=UDim2.new(lblWidth,-4,1,0); lbl.Position=UDim2.new(0,14,0,0)
	lbl.BackgroundTransparency=1; lbl.Text=label; lbl.TextColor3=C_ACCENT
	...
	if keybindStateKey then
		...
		kbBtn.Size = UDim2.new(0,58,0,22); kbBtn.Position = UDim2.new(1,-118,0.5,-11)
		kbBtn.BackgroundColor3 = C_BG; kbBtn.BorderSizePixel = 0
		kbBtn.Text = keyName; kbBtn.TextColor3 = C_ACCENT2
		kbBtn.Font = Enum.Font.GothamBold; kbBtn.TextSize = 10; kbBtn.ZIndex = 6
		addCorner(kbBtn,6); local kbs = addStroke(kbBtn, C_BORDER2, 1, 0.3)
		local listening = false
		local lConn = nil
		local function stopListen(k)
			listening = false
			if lConn then lConn:Disconnect(); lConn=nil end
			kbs.Color = C_BORDER2; kbBtn.TextColor3 = C_ACCENT2
			if k then State[keybindStateKey] = k; kbBtn.Text = k.Name; autoSaveConfig() end
		end
		kbBtn.MouseButton1Click:Connect(function()
			if listening then stopListen(nil); return end
			listening = true; kbBtn.Text = "..."; kbBtn.TextColor3 = C_WHITE; kbs.Color = C_YSLEM
	...
	local pill = Instance.new("Frame", row); pill.Size = UDim2.new(0,42,0,22); pill.Position = UDim2.new(1,-52,0.5,-11)
	pill.BackgroundColor3 = defaultOn and C_ON_BG or C_OFF_BG; pill.BorderSizePixel = 0; pill.ZIndex = 5
	addCorner(pill,11); local pStroke = addStroke(pill, defaultOn and C_YSLEM or C_BORDER, 1, 0.2)
	...
	local function setV(on)
		...
		TweenService:Create(pStroke,TweenInfo.new(0.2),{Color=on and C_YSLEM or C_BORDER}):Play()
		TweenService:Create(dot,TweenInfo.new(0.2,Enum.EasingStyle.Back),{Position=on and UDim2.new(1,-19,0.5,-8) or UDim2.new(0,3,0.5,-8), BackgroundColor3=on and C_WHITE or C_DIM}):Play()
	end
	local clk = Instance.new("TextButton", row); clk.Size = UDim2.new(1,0,1,0); clk.Position = UDim2.new(0,0,0,0); clk.BackgroundTransparency = 1; clk.Text = ""; clk.ZIndex = 3
...
normalBox = makeInputRow("Normal Speed", State.normalSpeed, function(v) local n=tonumber(v); if n and n>0 then State.normalSpeed=n end end)
carryBox = makeInputRow("Carry Speed", State.carrySpeed, function(v) local n=tonumber(v); if n and n>0 then State.carrySpeed=n end end)
laggerBox = makeInputRow("Lagger Normal", State.laggerSpeed, function(v) local n=tonumber(v); if n and n>0 then State.laggerSpeed=n end end)
carryLaggerBox = makeInputRow("Lagger Steal", State.laggerCarrySpeed, function(v) local n=tonumber(v); if n and n>0 then State.laggerCarrySpeed=n end end)
modeValLbl = makeStatusRow("Mode", "Normal")

makeGap(6)
makeSectionLabel("Combat")
setAutoBat = makeToggleRow("Auto Bat (Aimbot)", false, function(on)
...
local radiusBox = makeInputRow("Grab Radius", AutoSteal.Radius, function(v)
	local n = tonumber(v); if n and n>=5 and n<=300 then AutoSteal.Radius = math.floor(n); if progressRadLbl then progressRadLbl.Text = "Radius "..AutoSteal.Radius end; _promptCache = nil end
end)
...
setInstaGrab = makeToggleRow("Auto Grab", false, function(on)
	AutoSteal.Enabled = on
	if on then startAutoSteal() else stopAutoSteal() end
end)
setAutoCarry = makeToggleRow("Auto Carry on Grab", State.autoCarryOnGrab, function(on) State.autoCarryOnGrab=on end)
...
setUnwalkToggle = makeToggleRow("Unwalk", false, function(on) if on then startUnwalk() else stopUnwalk() end end)

makeGap(6)
makeSectionLabel("Teleport")
setMenuDropBR = makeToggleRow("Drop Brainrot", false, function(on)
	if on then runDropBrainrot(); task.delay(0.5,function() if setMenuDropBR then setMenuDropBR(false) end; if MobileButtons.Buttons.dropBR then MobileButtons.Buttons.dropBR(false) end end) end
end, "keyDropBR")
...
footerLbl.Text = "Yslem Hub · v2.0"; footerLbl.TextColor3 = C_DIM
...
-- ===================================================================
-- MOBILE BUTTONS PANEL (à droite, déplaçables)
-- ===================================================================
local function createMobilePanel()
	local panel = Instance.new("ScreenGui")
	panel.Name = "YslemMobile"; panel.Parent = LP:WaitForChild("PlayerGui")
	panel.ResetOnSpawn = false; panel.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

	local BTN_W,BTN_H,CORNER,GAP = 60,60,15,12
	local COL1_X = -(BTN_W+GAP+BTN_W+12)
	local COL2_X = -(BTN_W+12)
	local BASE_Y = 0.30
	...
	local function makeBtn(name, text, defaultPos, saveKey, callback, isToggle)
		local cont = Instance.new("Frame", panel); cont.Name = name
		cont.BackgroundColor3 = C_PANEL; cont.BorderSizePixel = 0
		cont.Size = UDim2.new(0,BTN_W,0,BTN_H); cont.Position = defaultPos
		addCorner(cont,CORNER); local cstroke = addStroke(cont, C_BORDER, 1, 0.3)
		...
		btn.TextColor3 = C_ACCENT; btn.TextSize = 12; btn.TextWrapped = true; btn.AutoButtonColor = false
		local active = false
		local function setActive(s)
			active = s
			TweenService:Create(cont,TweenInfo.new(0.18),{BackgroundColor3 = s and C_ON_BG or C_PANEL}):Play()
			TweenService:Create(cstroke,TweenInfo.new(0.18),{Color = s and C_YSLEM or C_BORDER}):Play()
		...
		cont.Visible = MobileButtons.Visible
	...
	local lagger = makeBtn("BtnLagger","LAGGER\nMODE",UDim2.new(1,COL2_X,BASE_Y,ROW_Y[4]),"YslemBtn_lagger.txt",function(setA) toggleLagger(); setA(State.laggerActive) end, true)

	MobileButtons.Buttons = {autoLeft=autoLeft,autoRight=autoRight,autoBat=autoBat,carrySpeed=carrySpd,lagger=lagger,dropBR=dropBR,tpDown=tpDown,laggerCarry=laggerCarry}
	task.spawn(function()
		task.wait(0.1)
...
local function setupChar(char)
	...
	setupFullDebug(char, h, hrp)  -- debug complet
	-- Recréer le proxy et relancer le patrol si actif
	proxy = nil
	ensureProxy()
	task.spawn(function()
		task.wait(0.5)
...
-- Anti-chute sous la map (technique SZG)
RunService.Stepped:Connect(function()
	local c = LP.Character
	if c then
...
local function loadConfig()
	local hasFile = false; pcall(function() hasFile = isfile("YslemHubConfig.json") end)
	if not hasFile then return end
	local ok, cfg = pcall(function() return HttpService:JSONDecode(readfile("YslemHubConfig.json")) end)
	...
	if cfg.laggerSpeed then State.laggerSpeed = cfg.laggerSpeed; laggerBox.Text = tostring(cfg.laggerSpeed) end
	if cfg.laggerCarrySpeed then State.laggerCarrySpeed = cfg.laggerCarrySpeed; carryLaggerBox.Text = tostring(cfg.laggerCarrySpeed) end
	...
	if cfg.grabRadius then AutoSteal.Radius = cfg.grabRadius; radiusBox.Text = tostring(cfg.grabRadius); if progressRadLbl then progressRadLbl.Text = "Radius "..cfg.grabRadius end end
	if cfg.grabDuration then AutoSteal.Duration = cfg.grabDuration; durationBox.Text = tostring(cfg.grabDuration) end
	if cfg.autoCarryOnGrab ~= nil then State.autoCarryOnGrab = cfg.autoCarryOnGrab; if setAutoCarry then setAutoCarry(cfg.autoCarryOnGrab) end end
	if cfg.autoStealEnabled then AutoSteal.Enabled = true; setInstaGrab(true); startAutoSteal() end
	...
	if cfg.autoTpDown ~= nil then State.autoTpDownEnabled = cfg.autoTpDown; if setAutoTpDown then setAutoTpDown(cfg.autoTpDown) end end
	...
	loadKey("keyDropBR","keyDropBR"); loadKey("keyTpDown","keyTpDown"); loadKey("keyAutoBat","keyAutoBat")
	task.spawn(function()
		task.wait(0.6)
		if MobileButtons.Buttons.autoBat then MobileButtons.Buttons.autoBat(State.autoBatToggled) end
		if MobileButtons.Buttons.carrySpeed then MobileButtons.Buttons.carrySpeed(State.speedType=="carry") end
...
loadConfig()
refreshUIToggles()
print("[Yslem Hub v2] Chargé avec succès")))()
