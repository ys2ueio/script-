...
(function (root) {
  ...
  var SHOPS = [
    { id: 'discord', name: 'Discord Shop',     icon: '💜', blurb: 'Nitro, boosts and server extras.' },
    { id: 'ai',      name: 'AI Shop',          icon: '🤖', blurb: 'Chat assistants on paid tiers.' },
    { id: 'stream',  name: 'Streaming Shop',   icon: '🎬', blurb: 'Video and music, lifetime keys and accounts.' },
    { id: 'vpn',     name: 'VPN Shop',         icon: '🔒', blurb: 'Lifetime VPN access.' },
    { id: 'gaming',  name: 'Gaming Shop',      icon: '🎮', blurb: 'Accounts and currency across platforms.' },
    { id: 'tools',   name: 'Tools Shop',       icon: '🛠',  blurb: 'Editing software and reseller supplies.' },
    { id: 'smm',     name: 'Social Shop',      icon: '📈', blurb: 'Boosting services, per 1000.' }
  ];
  ...
  var RAW = [
    ...
    /* ════════ STREAMING SHOP ════════ */
    { i: 1, s: 'stream', b: 'netflix', n: 'Netflix Keys Lifetime (4K)', k: 'KEY', dur: 'Lifetime', p: 0.03, w: 0.10, stock: 198, f: 'hot',
      int: 'stream', opts: [['Standard', 0], ['4K', 0.05]],
      sp: { Plan: '4K Ultra HD' } },
    { i: 2, s: 'stream', b: 'netflix', n: 'Netflix FA 4K (Lifetime)', k: 'FA', dur: 'Lifetime', p: 0.50, w: 1.95, stock: 7,
      int: 'ai', sp: { Plan: 'Premium 4K' } },
    { i: 3, s: 'stream', b: 'disney', n: 'Disney+ Lifetime UHQ', k: 'KEY', dur: 'Lifetime', p: 0.12, w: 0.15, stock: 9,
      int: 'stream', opts: [['Standard', 0], ['Disney + Hulu', 0.20]],
      sp: { Plan: 'UHQ' } },
    { i: 4, s: 'stream', b: 'crunchy', n: 'Crunchyroll Lifetime Keys', k: 'KEY', dur: 'Lifetime', p: 0.12, stock: 27,
      int: 'stream', opts: [['Fan', 0], ['Mega Fan', 0.10]] },
    { i: 5, s: 'stream', b: 'hbo', n: 'HBO Max Lifetime', k: 'KEY', dur: 'Lifetime', p: 0.12, w: 0.14, stock: 12,
      int: 'stream', opts: [['Standard', 0], ['4K Ultimate', 0.15]] },
    { i: 6, s: 'stream', b: 'paramount', n: 'Paramount+ Lifetime', k: 'KEY', dur: 'Lifetime', p: 0.05, w: 0.15, stock: 240, f: 'best' },
    ...
    { i: 8, s: 'stream', b: 'prime', n: 'Prime Video Keys Lifetime', k: 'KEY', dur: 'Lifetime', p: 0.15, w: 0.29, stock: 43 },
    { i: 9, s: 'stream', b: 'spotify', n: 'Spotify Lifetime KEY', k: 'KEY', dur: 'Lifetime', p: 0.50, w: 1.30, stock: 60, f: 'hot',
    ...
    { i: 11, s: 'stream', b: 'apple', n: 'Apple Music+ FA (1 mois)', k: 'FA', dur: '1 month', mo: 1, p: 0.35, stock: 4 },

    /* ════════ AI SHOP ════════ */
    { i: 12, s: 'ai', b: 'openai', n: 'ChatGPT+ / Pro Lifetime', k: 'FA', dur: 'Lifetime', p: 0.99, w: 1.50, stock: 3, f: 'hot' },
    { i: 13, s: 'ai', b: 'gemini', n: 'Gemini Pro+ (Link 18 mois)', k: 'LINK', dur: '18 months', mo: 18, p: 0.75, w: 0.89, stock: 21 },
    { i: 14, s: 'ai', b: 'claude', n: 'Claude FA Unlimited (Daily)', k: 'FA', dur: '1 day', p: 2.99, stock: 27,
      d: ['Billed per day — pay only for the days you use it.'] },
    { i: 15, s: 'ai', b: 'claude', n: 'Claude FA Unlimited (Monthly)', k: 'FA', dur: '1 month', mo: 1, p: 4.00, stock: 7, f: 'best',
      d: ['Billed once for the full month, no daily top-ups needed.'] },

    /* ════════ DISCORD SHOP ════════ */
    { i: 16, s: 'discord', b: 'discord', n: '14x Server Boosts (1 semaine)', k: 'SERVICE', dur: '1 week', p: 1.25, stock: 11,
      d: ['Send your server invite link in the ticket message.'], sp: { Amount: '14 boosts' } },
    { i: 17, s: 'discord', b: 'discord', n: '14x Server Boosts (1 mois)', k: 'SERVICE', dur: '1 month', mo: 1, p: 1.99, stock: 'instock', f: 'best',
      d: ['Send your server invite link in the ticket message.'], sp: { Amount: '14 boosts' } },
    { i: 18, s: 'discord', b: 'discord', n: 'Nitro Promo (3 mois)', k: 'GIFT', dur: '3 months', mo: 3, p: 0.59, w: 0.75, stock: 8, f: 'hot',
      int: 'nitro' },
    { i: 19, s: 'discord', b: 'discord', n: 'Nitro Boost ID (1 mois)', k: 'GIFT', dur: '1 month', mo: 1, p: 0.28, stock: 2,
      int: 'nitro', d: ['Full Nitro with boosts included, on one gift link.'] },
    { i: 20, s: 'discord', b: 'discord', n: 'Discord Random Decoration Keys', k: 'KEY', dur: 'Lifetime', p: 1.59, stock: 3,
      d: ['A random profile decoration from the Discord shop catalogue.'],
      w2: ['The decoration is randomly assigned, it cannot be chosen.'] },

    /* ════════ GAMING SHOP ════════ */
    { i: 21, s: 'gaming', b: 'fortnite', n: 'Fortnite FA Accounts (3-10 skins)', k: 'FA', dur: 'Permanent', p: 0.15, w: 1.00, stock: 24, f: 'hot',
      sp: { Skins: '3-10' } },
    { i: 22, s: 'gaming', b: 'roblox', n: 'Roblox 2000+ Robux Account', k: 'FA', dur: 'Permanent', p: 2.99, w: 4.00, stock: 3,
      sp: { Robux: '2000+' } },
    { i: 23, s: 'gaming', b: 'cs2', n: 'CS2 Prime NFA Accounts', k: 'KEY', dur: 'Permanent', p: 1.50, stock: 24,
      d: ['No Full Access — Prime status applied, sign in with the key.'] },
    { i: 24, s: 'gaming', b: 'valorant', n: 'Valorant Account (1-1000 skins)', k: 'FA', dur: 'Permanent', p: 0.07, stock: 145,
      sp: { Skins: '1-1000' } },
    { i: 25, s: 'gaming', b: 'steam', n: 'Steam (avec jeux, Lifetime)', k: 'FA', dur: 'Lifetime', p: 0.02, w: 0.50, stock: 215, f: 'best' },
    { i: 26, s: 'gaming', b: 'xbox', n: 'Xbox Gamepass Ultimate (12 mois)', k: 'KEY', dur: '12 months', mo: 12, p: 2.00, stock: 10,
      sp: { Tier: 'Ultimate' } },
    { i: 27, s: 'gaming', b: 'minecraft', n: 'Minecraft FA', k: 'FA', dur: 'Permanent', p: 0.29, w: 3.95, stock: 4 },
    { i: 28, s: 'gaming', b: 'fivem', n: 'FiveM Ready FA (Rockstar)', k: 'FA', dur: 'Permanent', p: 0.01, stock: 158,
      d: ['Rockstar account pre-checked as ready for FiveM roleplay servers.'] },

    /* ════════ VPN SHOP ════════ */
    { i: 29, s: 'vpn', b: 'express', n: 'ExpressVPN Lifetime', k: 'KEY', dur: 'Lifetime', p: 0.10, w: 0.15, stock: 3, f: 'best',
      sp: { Platform: 'iOS / Android' } },
    { i: 30, s: 'vpn', b: 'nord', n: 'NordVPN Lifetime', k: 'FA', dur: 'Lifetime', p: 0.55, stock: 24 },

    /* ════════ SOCIAL SHOP ════════ */
    { i: 31, s: 'smm', b: 'tiktok', n: 'TikTok Services', k: 'SERVICE', dur: 'Per 1000', p: 0.01, stock: 'instock',
      int: 'smm', smm: { unit: 'followers', min: 100, max: 50000, step: 100, rate: 0.01, field: 'TikTok username', ph: '@yourhandle' } },
    { i: 32, s: 'smm', b: 'instagram', n: 'Instagram Boosting', k: 'SERVICE', dur: 'Per 1000', p: 0.01, stock: 'instock',
      int: 'smm', smm: { unit: 'followers', min: 100, max: 50000, step: 100, rate: 0.01, field: 'Instagram username', ph: '@yourhandle' } },
    { i: 33, s: 'smm', b: 'youtube', n: 'YouTube Boosting', k: 'SERVICE', dur: 'Per 1000', p: 0.01, stock: 'instock',
      int: 'smm', smm: { unit: 'views', min: 1000, max: 200000, step: 1000, rate: 0.01, field: 'Video link', ph: 'youtube.com/watch?v=...' } },
    { i: 34, s: 'smm', b: 'telegram', n: 'Telegram Boost', k: 'SERVICE', dur: 'Per 1000', p: 0.01, w: 1.15, stock: 'instock', f: 'hot',
      int: 'smm', smm: { unit: 'members', min: 100, max: 20000, step: 100, rate: 0.01, field: 'Channel link', ph: 't.me/yourchannel' } },
    { i: 35, s: 'smm', b: 'twitch', n: 'Twitch Boost', k: 'SERVICE', dur: 'Per 1000', p: 0.01, stock: 'instock',
      int: 'smm', smm: { unit: 'followers', min: 100, max: 20000, step: 100, rate: 0.01, field: 'Twitch channel', ph: 'twitch.tv/yourchannel' } },
    { i: 36, s: 'smm', b: 'facebook', n: 'Facebook Boost', k: 'SERVICE', dur: 'Per 1000', p: 0.01, stock: 'instock',
      int: 'smm', smm: { unit: 'likes', min: 100, max: 20000, step: 100, rate: 0.01, field: 'Page link', ph: 'facebook.com/yourpage' } },
    { i: 37, s: 'smm', b: 'twitter', n: 'X (Twitter) Boost', k: 'SERVICE', dur: 'Per 1000', p: 0.01, stock: 'instock',
      int: 'smm', smm: { unit: 'followers', min: 100, max: 50000, step: 100, rate: 0.01, field: 'X username', ph: '@yourhandle' } },
    { i: 38, s: 'smm', b: 'kick', n: 'Kick Boost', k: 'SERVICE', dur: 'Per 1000', p: 0.01, stock: 'instock',
      int: 'smm', smm: { unit: 'followers', min: 100, max: 20000, step: 100, rate: 0.01, field: 'Kick channel', ph: 'kick.com/yourchannel' } },

    /* ════════ TOOLS SHOP ════════ */
    { i: 39, s: 'tools', b: 'capcut', n: 'CapCut Pro Lifetime', k: 'KEY', dur: 'Lifetime', p: 0.12, w: 0.15, stock: 30 },
    { i: 40, s: 'tools', b: 'accsupplier', n: 'NFA Accs Supplier', k: 'SERVICE', dur: 'Per account', p: 1.50, w: 7.00, stock: 'instock',
      d: ['Bulk account supply for resellers — priced per account, no login required to order.'],
      sp: { Unit: 'Per account' } },
    { i: 41, s: 'tools', b: 'discord', n: 'Discord Tool & Bot SRC', k: 'TOOL', dur: 'Lifetime', p: 0.85, stock: 'instock',
      d: ['Source code for a Discord bot, delivered with setup instructions.'],
      sp: { Format: 'Source code' } },
    { i: 42, s: 'tools', b: 'sellauth', n: 'SellAuth Themes (Flame / Retro)', k: 'TOOL', dur: 'Lifetime', p: 1.00, stock: 50,
